      ...
      <div className="h-screen w-screen bg-gray-50 overflow-hidden">
        ...
        >
          ...
          <div className="flex flex-col w-full overflow-hidden">
            ...
            <div className="block lg:hidden p-4 bg-white shadow rounded-b-lg overflow-hidden w-full">
              <NationwideCharts chartData={chartData} />
            </div>
          </div>

          {/* RIGHT PANEL */}
          <div className="p-4 lg:pt-6 lg:pr-6 overflow-y-auto overflow-x-hidden w-full">
            <RightPanel />
          </div>
        </div>
      </div>
