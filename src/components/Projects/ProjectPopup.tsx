    ...
    >
      ...
      >
        ...
        <div className="text-gray-300 space-y-2">
          <p>
            <b>Type:</b>{" "}
            {project.Class !== undefined
              ? CLASS_LABELS[project.Class] || "N/A"
              : "N/A"}
          </p>
          <p>
            <b>Stage:</b>{" "}
            {project.Stage !== undefined
              ? STAGE_LABELS[project.Stage] || "N/A"
              : "N/A"}
          </p>
          <p>
            <b>Premises Type:</b>{" "}
            {project.Type !== undefined
              ? TYPE_LABELS[project.Type] || "N/A"
              : "N/A"}
          </p>
          <p>
            <b>Year:</b> {project.Year || "N/A"}
          </p>
          <p>
            <b>Size:</b> {project.Size || "N/A"}
          </p>
          {project.Inspection && (
            <p>
              <b>Inspection:</b>{" "}
