...
//   return (
//     <div>
//       <h2 className="text-3xl font-bold mb-6">PROJECTS STATISTICS</h2>

//       <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-10">

//         {/* Pie Chart */}
//         <div className="bg-[#132032] p-5 rounded-xl border border-gray-700 flex items-center justify-center">
//           <Pie
//             data={{
...
//                   borderColor: ["#0B6E4F", "#eab308", "#dc2626"],
//                   borderWidth: 1,
//                 },
//               ],
//             }}
